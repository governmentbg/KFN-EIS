...
import bg.government.regixclient.nra.socialsecurity.declarations.SocialSecurityDataFromDeclarationRequestType;
...
@XmlSeeAlso({
        bg.government.regixclient.grao.pna.PermanentAddressRequestType.class,
        bg.government.regixclient.grao.pna.TemporaryAddressRequestType.class,
        bg.government.regixclient.grao.nbd.PersonDataRequestType.class,
        bg.government.regixclient.grao.nbd.RelationsRequestType.class,
        bg.government.regixclient.grao.nbd.ValidPersonRequestType.class,

        bg.government.regixclient.rezmaa.checkobligations.CheckObligationsRequestType.class,

        bg.government.regixclient.nra.employmentcontracts.EmploymentContractsRequest.class,
        bg.government.regixclient.nra.employmentcontracts.EikTypeTypeRequest.class,
        bg.government.regixclient.nra.employmentcontracts.IdentityTypeRequest.class,
        bg.government.regixclient.nra.employmentcontracts.StatusTypeRequest.class,

        bg.government.regixclient.nra.obligatedperson.EikTypeTypeRequest.class,
        bg.government.regixclient.nra.obligatedperson.IdentityTypeRequest.class,
        bg.government.regixclient.nra.obligatedperson.ObligationRequest.class,
        bg.government.regixclient.nra.obligatedperson.StatusTypeRequest.class,

        bg.government.regixclient.nra.socialsecurity.declarations.SocialSecurityDataFromDeclarationRequestType.class,

        bg.government.regixclient.ncid.academicrecognition.AcademicRecognitionRequestType.class
})
