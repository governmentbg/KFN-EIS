 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="ID" type="{http://egov.bg/RegiX/NRA/EmploymentContracts/Request}IDTypeRequest"/&amp;gt;
 *         &amp;lt;element name="TYPE" type="{http://egov.bg/RegiX/NRA/EmploymentContracts/Request}EikTypeTypeRequest"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
@XmlType(name = "IdentityTypeRequest", namespace = "http://egov.bg/RegiX/NRA/EmploymentContracts/Request", propOrder = {
    "id",
    "type"
})
