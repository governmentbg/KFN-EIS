 ...
 *         &amp;lt;element name="TYPE" type="{http://egov.bg/RegiX/NRA/Obligations}EikTypeType"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
public class IdentityType {
    ...
    @XmlElement(name = "ID", namespace = "http://egov.bg/RegiX/NRA/Obligations", required = true)
    protected String id;
    @XmlElement(name = "TYPE", namespace = "http://egov.bg/RegiX/NRA/Obligations", required = true)
